...
- For personal use, default source access to the configured read-only remote repository codebase MCP `repo_codebase`. Treat its exposed read/list/search/symbol capabilities as the first source repository entrypoint.
